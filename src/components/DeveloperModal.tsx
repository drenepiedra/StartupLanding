...
export const DeveloperModal: React.FC<DeveloperModalProps> = ({
  ...
  const tsCode = `import { FelineMeshClient } from '@myproject/sdk';
...
const unsubscribe = client.telemetry.subscribe('TRK-902-FELINE', (event) => {
  ...
  const pythonCode = `from myproject import FelineClient
            ...
            <div className="space-y-6 animate-fadeIn font-mono-tech text-xs">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[#c5c0ff] font-semibold">
            ...
            <div className="space-y-4 animate-fadeIn font-mono-tech text-xs">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  <Zap
                    className={`w-3.5 h-3.5 ${isSendingTest ? "animate-spin" : ""}`}
                  />
          ...
          {activeTab === "keys" && (
            <div className="space-y-6 animate-fadeIn font-mono-tech text-xs">
              <div className="bg-[#201f21] p-4 rounded border border-white/10 space-y-4">
                <div>
                  <label className="block text-[#928f9e] mb-1">
                    YOUR ACTIVE API KEY:
                  </label>
